            ...
            <div className="wrapper px-4 py-5 md:px-6 md:py-8">
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">Your one-stop shop for all things fashion and
                            lifestyle.</p>
                ...
                <div
                    className="mt-12 border-t pt-8 text-center text-sm text-muted-foreground flex flex-col-reverse gap-2 md:gap-0 md:flex-row items-center justify-between pb-[52px] lg:pb-0">
